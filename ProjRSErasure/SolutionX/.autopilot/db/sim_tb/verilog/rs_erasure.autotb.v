...
`define AUTOTB_TVIN_d_0  "./c.rs_erasure.autotvin_d_0.dat"
`define AUTOTB_TVIN_d_1  "./c.rs_erasure.autotvin_d_1.dat"
`define AUTOTB_TVIN_d_2  "./c.rs_erasure.autotvin_d_2.dat"
`define AUTOTB_TVIN_d_3  "./c.rs_erasure.autotvin_d_3.dat"
`define AUTOTB_TVIN_d_4  "./c.rs_erasure.autotvin_d_4.dat"
`define AUTOTB_TVIN_d_5  "./c.rs_erasure.autotvin_d_5.dat"
`define AUTOTB_TVIN_d_6  "./c.rs_erasure.autotvin_d_6.dat"
`define AUTOTB_TVIN_d_7  "./c.rs_erasure.autotvin_d_7.dat"
`define AUTOTB_TVIN_d_8  "./c.rs_erasure.autotvin_d_8.dat"
`define AUTOTB_TVIN_d_9  "./c.rs_erasure.autotvin_d_9.dat"
`define AUTOTB_TVIN_d_10  "./c.rs_erasure.autotvin_d_10.dat"
`define AUTOTB_TVIN_d_11  "./c.rs_erasure.autotvin_d_11.dat"
`define AUTOTB_TVIN_survival_pattern  "./c.rs_erasure.autotvin_survival_pattern.dat"
`define AUTOTB_TVIN_codeidx  "./c.rs_erasure.autotvin_codeidx.dat"
`define AUTOTB_TVIN_d_0_out_wrapc  "./rtl.rs_erasure.autotvin_d_0.dat"
`define AUTOTB_TVIN_d_1_out_wrapc  "./rtl.rs_erasure.autotvin_d_1.dat"
`define AUTOTB_TVIN_d_2_out_wrapc  "./rtl.rs_erasure.autotvin_d_2.dat"
`define AUTOTB_TVIN_d_3_out_wrapc  "./rtl.rs_erasure.autotvin_d_3.dat"
`define AUTOTB_TVIN_d_4_out_wrapc  "./rtl.rs_erasure.autotvin_d_4.dat"
`define AUTOTB_TVIN_d_5_out_wrapc  "./rtl.rs_erasure.autotvin_d_5.dat"
`define AUTOTB_TVIN_d_6_out_wrapc  "./rtl.rs_erasure.autotvin_d_6.dat"
`define AUTOTB_TVIN_d_7_out_wrapc  "./rtl.rs_erasure.autotvin_d_7.dat"
`define AUTOTB_TVIN_d_8_out_wrapc  "./rtl.rs_erasure.autotvin_d_8.dat"
`define AUTOTB_TVIN_d_9_out_wrapc  "./rtl.rs_erasure.autotvin_d_9.dat"
`define AUTOTB_TVIN_d_10_out_wrapc  "./rtl.rs_erasure.autotvin_d_10.dat"
`define AUTOTB_TVIN_d_11_out_wrapc  "./rtl.rs_erasure.autotvin_d_11.dat"
`define AUTOTB_TVIN_survival_pattern_out_wrapc  "./rtl.rs_erasure.autotvin_survival_pattern.dat"
`define AUTOTB_TVIN_codeidx_out_wrapc  "./rtl.rs_erasure.autotvin_codeidx.dat"
`define AUTOTB_TVOUT_c_0  "./c.rs_erasure.autotvout_c_0.dat"
`define AUTOTB_TVOUT_c_1  "./c.rs_erasure.autotvout_c_1.dat"
`define AUTOTB_TVOUT_c_2  "./c.rs_erasure.autotvout_c_2.dat"
`define AUTOTB_TVOUT_c_3  "./c.rs_erasure.autotvout_c_3.dat"
`define AUTOTB_TVOUT_c_0_out_wrapc  "./impl_rtl.rs_erasure.autotvout_c_0.dat"
`define AUTOTB_TVOUT_c_1_out_wrapc  "./impl_rtl.rs_erasure.autotvout_c_1.dat"
`define AUTOTB_TVOUT_c_2_out_wrapc  "./impl_rtl.rs_erasure.autotvout_c_2.dat"
`define AUTOTB_TVOUT_c_3_out_wrapc  "./impl_rtl.rs_erasure.autotvout_c_3.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.rs_erasure.autotvout_c_0.dat", "r");
    fp2 = $fopen("./impl_rtl.rs_erasure.autotvout_c_0.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.rs_erasure.autotvout_c_0.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.rs_erasure.autotvout_c_0.dat\"!");
    else begin
        $display("Comparing rtl.rs_erasure.autotvout_c_0.dat with impl_rtl.rs_erasure.autotvout_c_0.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.rs_erasure.autotvout_c_1.dat", "r");
    fp2 = $fopen("./impl_rtl.rs_erasure.autotvout_c_1.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.rs_erasure.autotvout_c_1.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.rs_erasure.autotvout_c_1.dat\"!");
    else begin
        $display("Comparing rtl.rs_erasure.autotvout_c_1.dat with impl_rtl.rs_erasure.autotvout_c_1.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.rs_erasure.autotvout_c_2.dat", "r");
    fp2 = $fopen("./impl_rtl.rs_erasure.autotvout_c_2.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.rs_erasure.autotvout_c_2.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.rs_erasure.autotvout_c_2.dat\"!");
    else begin
        $display("Comparing rtl.rs_erasure.autotvout_c_2.dat with impl_rtl.rs_erasure.autotvout_c_2.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.rs_erasure.autotvout_c_3.dat", "r");
    fp2 = $fopen("./impl_rtl.rs_erasure.autotvout_c_3.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.rs_erasure.autotvout_c_3.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.rs_erasure.autotvout_c_3.dat\"!");
    else begin
        $display("Comparing rtl.rs_erasure.autotvout_c_3.dat with impl_rtl.rs_erasure.autotvout_c_3.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
