...
#ifndef __rs_erasure_F_tbl_H__
#define __rs_erasure_F_tbl_H__
...
struct rs_erasure_F_tbl_ram : public sc_core::sc_module {
...
rs_erasure_F_tbl_ram* meminst;


SC_CTOR(rs_erasure_F_tbl) {
meminst = new rs_erasure_F_tbl_ram("rs_erasure_F_tbl_ram");
