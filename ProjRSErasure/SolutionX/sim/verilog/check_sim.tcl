...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.rs_erasure.autotvin_d_0.dat"
         "c.rs_erasure.autotvin_d_1.dat"
         "c.rs_erasure.autotvin_d_2.dat"
         "c.rs_erasure.autotvin_d_3.dat"
         "c.rs_erasure.autotvin_d_4.dat"
         "c.rs_erasure.autotvin_d_5.dat"
         "c.rs_erasure.autotvin_d_6.dat"
         "c.rs_erasure.autotvin_d_7.dat"
         "c.rs_erasure.autotvin_d_8.dat"
         "c.rs_erasure.autotvin_d_9.dat"
         "c.rs_erasure.autotvin_d_10.dat"
         "c.rs_erasure.autotvin_d_11.dat"
         "c.rs_erasure.autotvin_survival_pattern.dat"
         "c.rs_erasure.autotvin_codeidx.dat"
         "c.rs_erasure.autotvout_c_0.dat"
         "c.rs_erasure.autotvout_c_1.dat"
         "c.rs_erasure.autotvout_c_2.dat"
         "c.rs_erasure.autotvout_c_3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.rs_erasure.autotvout_c_0.dat"
         "rtl.rs_erasure.autotvout_c_1.dat"
         "rtl.rs_erasure.autotvout_c_2.dat"
         "rtl.rs_erasure.autotvout_c_3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
