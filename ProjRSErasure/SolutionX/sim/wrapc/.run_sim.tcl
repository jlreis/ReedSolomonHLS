...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "rs_erasure.autotvin.dat"
	set constFileTvOut       "rs_erasure.autotvout.dat"
	set constFileHdlTvIn     "rs_erasure.autohdltvin.dat"
	set constFileHdlTvOut    "rs_erasure.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
