...
$(ObjDir)/tb_rs_erasure.c_pre.c.tb.o : tb_rs_erasure.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) tb_rs_erasure.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/rs_erasure.c_pre.c.tb.o : rs_erasure.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) rs_erasure.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
