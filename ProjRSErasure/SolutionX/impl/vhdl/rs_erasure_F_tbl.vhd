...
entity rs_erasure_F_tbl_rom is 
    generic(
             dwidth     : integer := 9; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of rs_erasure_F_tbl_rom is 
...
signal mem0 : mem_array := (
    0 to 15=> "000000001", 16 => "000000000", 17 => "000000001", 18 => "000000010", 
    19 => "000000011", 20 => "000000100", 21 => "000000101", 22 => "000000110", 
    23 => "000000111", 24 => "000001000", 25 => "000001001", 26 => "000001010", 
    27 => "000001011", 28 => "000001100", 29 => "000001101", 30 => "000001110", 
    31 => "000001111", 32 to 33=> "000000000", 34 => "000000001", 35 => "000000011", 
    36 => "000000110", 37 => "000001010", 38 => "000001111", 39 => "000010101", 
    40 => "000011100", 41 => "000100100", 42 => "000101101", 43 => "000110111", 
    44 => "001000010", 45 => "001001110", 46 => "001011011", 47 => "001101001", 
    48 to 50=> "000000000", 51 => "000000001", 52 => "000000100", 53 => "000001010", 
    54 => "000010100", 55 => "000100011", 56 => "000111000", 57 => "001010100", 
    58 => "001111000", 59 => "010100101", 60 => "011011100", 61 => "100011110", 
    62 => "101101100", 63 => "111000111" );
...
architecture arch of rs_erasure_F_tbl is
    component rs_erasure_F_tbl_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    rs_erasure_F_tbl_rom_U :  component rs_erasure_F_tbl_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
